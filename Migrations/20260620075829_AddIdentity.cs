...
namespace Cetee.Migrations
{
    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Backfill các trường Identity cho dữ liệu cũ để đăng nhập theo email vẫn đúng.
            // (Unique index UserNameIndex/RoleNameIndex có filter IS NOT NULL nên NULL không vướng;
            //  email/role vốn duy nhất nên giá trị chuẩn hóa cũng duy nhất.)
